...
emoji_dist = {0: cur_path + "./emojis/Angry.png", 1: cur_path + "./emojis/Disgusted.png",
              2: cur_path + "./emojis/Fear.png", 3: cur_path + "./emojis/Happy.png",
...
def show_vid():
    ...
    #     exit()
    cam.set(1, frame_number)
    flag1, frame1 = cam.read()
    frame1 = cv2.resize(frame1, (780, 640))

    bounding_box = cv2.CascadeClassifier('F:/Emoji/haarcascade_frontalface_default.xml')
...
if __name__ == '__main__':
    ...
    # heading.pack()
    heading2 = Label(root, text="Emotion to Emoji", pady=20, font=('arial', 45, 'bold'), bg='black', fg='#CDCDCD')
